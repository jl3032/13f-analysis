...
AI 驱动的 SEC 13F 持仓分析工具，面向全球散户和独立研究者。追踪巴菲特、Ackman、木头姐、Burry 等投资人的买卖动向，把原始 13F 申报转成更容易理解的交互式 HTML 报告。
...
- **普通散户**：不想直接啃 13F 原始文件，想先看清楚重点
- **独立研究者**：要跟踪基金经理季度动作和长期持仓
- **内容创作者**：需要把 filing 快速整理成可读结论
- **双语用户**：希望英文优先，同时保留本地化解释能力
...
- **行情参考链接** — 每只股票可直接跳转查看行情
- **语言自适应** — 默认跟随用户语言，需要时补充本地化名称/说明
- **响应式** — 电脑和手机都能用
...
| 分类 | 基金经理 |
|------|----------|
| 🌍 全球关注度高 | 巴菲特、大空头 Burry、木头姐 ARK、Ackman |
| 💰 价值投资 | 段永平、李录、Klarman、Pabrai |
| 📈 宏观 / 事件驱动 | Druckenmiller、Ray Dalio、Tepper、Einhorn |
| 🚀 成长 / 科技 | Tiger Global、Coatue、高瓴 |
...
这个项目并不是要做一个完整的 13F 数据终端，也不是专业机构级数据库产品。
